...
![](../../assets/images/admin-credits/img01.png)

- 크레딧 결제는 [관리자 설정] > [크레딧 결제] > [충전하기] 를 통해 가능해요.

![](../../assets/images/admin-credits/img02.png)
...
![](../../assets/images/admin-credits/img03.png)

- [인터넷 뱅킹] 통해 결제할 경우, 세금계산서를 발급받을 수 있어요.
- 발급이 필요 없을 경우에는 [발급 안함]을 선택해 주세요.

![](../../assets/images/admin-credits/img04.png)
...
![](../../assets/images/admin-credits/img06.png)
