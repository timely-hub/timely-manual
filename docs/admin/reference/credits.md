...
![](../../assets/images/admin-ref-credits/img01.png)
...
![](../../assets/images/admin-ref-credits/img02.png)

- [어드민 설정] > [크레딧 결제] 에서 충전이 가능해요

![](../../assets/images/admin-ref-credits/img03.png)
...
![](../../assets/images/admin-ref-credits/img04.png)

- [인터넷 뱅킹] 결제 시 세금계산서 발급이 가능해요.

![](../../assets/images/admin-ref-credits/img05.png)

- 세금계산서 발급에 필요한 서류나 이미지를 등록 후 이메일과 전화번호를 입력해요.

![](../../assets/images/admin-ref-credits/img06.png)
...
![](../../assets/images/admin-ref-credits/img07.png)
