...
![](../../assets/images/user-ai-agents/img01.png)
...
![](../../assets/images/user-ai-agents/img02.png)

## 1. 에이전트 만들기

![](../../assets/images/user-ai-agents/img03.png)

AI 에이전트에서 [에이전트 만들기]를 통해 나만의 에이전트를 만들 수 있어요.

![](../../assets/images/user-ai-agents/img04.png)
...
![](../../assets/images/user-ai-agents/img05.png)

각 노드별로 모델을 선택하거나 출력 형태, 입력값 바인딩을 설정하는 등 설계에 따른 커스텀이 가능해요.

![](../../assets/images/user-ai-agents/img06.png)
...
![](../../assets/images/user-ai-agents/img07.png)
